...
const AppProvider = ({ children }) => {
    ...
    return <AppContext.Provider value={{ loading, setLoading, movieList, setMovieList, errorAPI, setErrorAPI, searchQuery, setSearchQuery, movieDetail, setMovieDetail }}>{children}</AppContext.Provider>
}
